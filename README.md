...
To setup the project, you must configure your database information in ecosystem.config.js MYQSL object:
```
{
  HOST: '',
  USER: '',
...
Then you must execute the module install command: 
```
yarn
or
npm install
```
and compile the babel code with: 
```
yarn build
or
npm run build
